...
### 2. **Active Positions Panel in SentientReveal**
...
- SentientReveal shows both pending orders and active positions

### Option C: Position Management Tab
- Add new tab in SentientReveal: "Positions"
- Shows all active positions
- Can create exit conditions from this view

## Recommended: Hybrid Approach
1. **Terminal**: Support both entry and exit commands
2. **SentientReveal**: Add "Positions" tab showing active positions
