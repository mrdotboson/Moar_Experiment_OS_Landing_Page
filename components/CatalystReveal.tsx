...
export default function CatalystReveal({ userInput, strategy, onReset, onStrategyUpdate }: CatalystRevealProps) {
    ...
    <div className="absolute inset-0 bg-bloomberg-bg z-30">
      ...
      <div className="bg-bloomberg-panel border-b border-terminal h-6 flex items-center justify-between px-2 text-xs">
        <div className="flex items-center gap-4">
          <span className="text-[#8B5CF6] font-bold">CATALYST TERMINAL</span>
